...
library Flag {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Flag", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000466c6167000000000000000000000000);
