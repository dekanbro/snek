...
library SnakeLength {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "SnakeLength", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000536e616b654c656e6774680000000000);
