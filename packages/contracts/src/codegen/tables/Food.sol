...
library Food {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "", name: "Food", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74620000000000000000000000000000466f6f64000000000000000000000000);
